(() => {
    ...
    function mainFunc() {
        document.addEventListener("click", (function(e) {
            ...
            if (target.closest(".select__value") || target.closest(".select__option")) {
                ...
                if (selectValue) selectOptions.forEach(((select, i) => {
                    select.style.top = `${selectValue[i].clientHeight}px`;
                }));
            }
        }));
    ...
    function removeCard(target) {
        ...
        if (card.classList.contains("specialties__body")) {
